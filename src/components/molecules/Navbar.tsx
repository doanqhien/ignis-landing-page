      ...
      {isMounted && (
        ...
        >
          ...
          <div className=" flex flex-col items-center justify-center gap-4 px-6 py-8 min-h-max">
            ...
            {/* Email Section */}
            <div className={`flex items-center justify-center px-1 mb-8 w-full max-w-70 ${menuOpen ? 'animate-in fade-in slide-in-from-bottom-5 duration-500 ease-out delay-300 fill-mode-both' : 'opacity-0 transition-opacity duration-100'}`}>
              ...
              <div className="flex-1 flex flex-col items-center justify-center py-2">
                ...
                <p className="text-[11px] tracking-[0.05rem] text-[#1a1a1c] font-medium">ADMIN@IGNISHYPERSONICS.COM</p>
              </div>
