  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between bg-transparent pointer-events-none z-10"
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className={`sm-toggle relative items-center border-0 cursor-pointer font-medium pointer-events-auto px-4 py-2 bg-zinc-400 ${
          ...
          >
            <span
              ref={iconRef}
              className="sm-icon relative [will-change:transform]"
              aria-hidden="true"
            >
              <span
                ref={plusHRef}
                className="sm-icon-line [will-change:transform]"
              />
              <span
                ref={plusVRef}
                className="sm-icon-line [will-change:transform]"
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full bg-[#243742] flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto"
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 1rem; pointer-events: none; z-index: 20; }
.sm-scope .staggered-menu-header > * { pointer-events: auto; }
.sm-scope .sm-logo { display: flex; align-items: center; user-select: none; }
.sm-scope .sm-logo-img { display: block; height: 32px; width: auto; object-fit: contain; }
.sm-scope .sm-toggle { position: relative; display: inline-flex; align-items: center; border: none; cursor: pointer; color: #e9e9ef; font-weight: 500; line-height: 1; overflow: visible; }
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: #243742; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
